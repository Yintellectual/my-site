<article>
	<header>
		<h1 class="w3-teal">Git and Github </h1>
	</header>

	<section class="w3-container">
	<h3 class="w3-orange">Easy Instruction to Github </h3>
	
	<p><a href="http://rogerdudler.github.io/git-guide/"> http://rogerdudler.github.io/git-guide/</a> </p>
	</section>
	
	<section class="w3-container">
	<h3 class="w3-orange">Remove a folder from github repository </h3>
...
git push origin master	
	...
	<section class="w3-container">
	<h3 class="w3-orange">upload a project to a Github repository </h3>
	...
	<section class="w3-container">
	<h3 class="w3-orange">How to upload a program to github </h3>
